...
31 章 + 1 篇个人化附录，正文约 30 万中文字。每章固定结构：为什么重要 → 核心机制 → AI 最常犯的错与怎么识别 → 判断清单 → 飞机上的练习（无网络可做，附评判标准）→ 落地后的练习 → 一句话记忆钩子。
...
| 起飞前或落地前 30 分钟 | 附录 A | 基于你 9 月 5 日口述与你仓库里的事实记录写的个人化战略推演：双边 FDE 路线、就业过滤器、每周时间预算、风险登记、24 个月路线 |
...
| **附录 · 个人化战略推演** | | |
| 附录 A | [你的战略推演：中国先落地、澳洲后收割的双边 FDE 路线](chapters/31-appendix-a-personal-strategy.md) | 30 |
