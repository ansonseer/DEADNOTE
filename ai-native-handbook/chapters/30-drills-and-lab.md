...
**30 条 AI 解释背后只有四种错法。**把上面三张表里 AI 的解释按偏差类型归类，它们几乎全落在四类里：症状层当根因（S3、S4、S6、S9、A1、A11）、怀疑模型太早（A2、A4）、把契约当 bug（S7、S8、A5——至少一次交付、锁租约到期、judge 偏好都是系统的固有性质，不是故障）、修症状不修机制（S2、S10、S11、S12、A6、A7）。这不是巧合——AI 的诊断是在补全"听起来像诊断的文本"，而这四种错法恰好是最常见的诊断文本的形状（第 11 章）。记住四类，你审 AI 诊断的速度会快一个量级。
