...
五个维度是漏斗式的：上一层没读清楚，下一层的结论就没有意义。数据再干净，不在瓶颈上就没人在乎；瓶颈找得再准，如果那一步的负责人正是会否决你的人，项目会在上线前一周死掉。
...
还有一条反直觉的纪律：**前两周不写代码**。一旦交付了能跑的东西，讨论就从"问题是什么"跳到"这功能能不能加"，再也回不到问题层。一次性的分析脚本不算——判据是：这段代码是用来**回答问题**，还是用来**演示方案**。
...
跟单还有个副作用：建立信任。坐在一线员工旁边三小时，他后面会告诉你会议室里不会说的话——"那个系统我们其实都不用"。
