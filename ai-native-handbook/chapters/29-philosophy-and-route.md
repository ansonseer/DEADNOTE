...
**5. 帮你写目的宣言时抹掉你的原话与语气。**
症状：你给它一段日记里的原话——"不要停止意识的流动"、"创造力与爱是最重要的两个课题"——它输出的版本是"持续保持思维的活跃与开放""重视创造力与人际情感的价值"。语义相近，但你的句子有你的重量，它的句子谁都能写。这是模型向训练分布的平均语气回归，在哲学文本上尤其致命，因为目的的力量恰恰在于它是你的。识别方法：把输出和你的原文并排，数一数你的原话有几句被保留、几句被"润色"掉了。或者干脆约束它："保留我的原话不改一字，你只能做三件事：调整顺序、加小标题、标出哪两句之间有逻辑跳跃。"它做不到只做这三件的时候，你就知道它有多想改写你。
